...
public class TransactionRecordsWindow extends JFrame {
    ...
    public TransactionRecordsWindow(String accountNumber) {
        ...
        DefaultTableModel transactionModel = getAccountRecords(accountNumber);
    ...
    private DefaultTableModel getAccountRecords(String accountNumber) {
        ...
        Account account = bankAccountDAO.loadAccount(accountNumber);
